...
public class cleanerSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cleaner_signup);
    ...
    public void cleaner (View view) {
        ...
        cleaner cleaner = new cleaner (id,Name, nic, address, mobile, email, password,C_Password);

        try {
            dataHandler.Cleaner_Create(cleaner);
            Toast.makeText(getApplicationContext(), "Successfully Registered.", Toast.LENGTH_SHORT).show();
            Intent intent=new Intent(cleanerSignup.this,cleanerLogin.class);
