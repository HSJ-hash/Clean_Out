...
import com.cleanCut.tidy.database.dataHandler;
...
public class addAds extends AppCompatActivity {
    ...
    com.cleanCut.tidy.database.dataHandler dataHandler = new dataHandler(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(addAds.this, "Data Updated Successfully", Toast.LENGTH_SHORT).show();
                    submit.setVisibility(android.view.View.VISIBLE);
                    edit.setVisibility(android.view.View.GONE);

                } else {
                    Toast.makeText(addAds.this, "Data Updated Failed", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void submit (android.view.View view) {
        ...
        if(recinsert!=null){
            Toast.makeText(addAds.this,"Adz Added Successfully",Toast.LENGTH_SHORT).show();
    ...
    public void display_adz(android.view.View view) {
        Intent intent = new Intent(addAds.this, display_ads.class);
